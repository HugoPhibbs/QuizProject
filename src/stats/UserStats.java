 ...
 * <p>
 * Creates graphs if requested representing trends from it's ArrayList of QuizStats 
 * entries
 * 
 * @author Tom Berry
 * @author Hugo Phibbs
...
public class UserStats implements Serializable {
	...
	public void createGraphs() {
		// TODO implement
		/* May want to split this up into different methods
		 * eg createAverageCorrectGraph(), createAverageWrongGraph()
		 */
	}
